...
Where $S_{ij}$ and $S_{ik}$ are the abundances of the $i$'th organism in sample $j$ and $k$, respectively. $R$ is the number of organisms. With the test data, the Bray-Curtis dissimilarity is calculated as follows:
